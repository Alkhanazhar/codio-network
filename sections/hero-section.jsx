...
export default function HeroSection() {
    ...
    return (
        <section className='flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 py-24 '>
            <div className='absolute inset-0 -z-10 bg-gradient-to-b from-[#fbea0079] via-[30%]  to-white'></div>
            ...
            <a href='https://prebuiltui.com' className='mt-32 flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-sm font-medium transition hover:bg-gray-100/80'>
                ...
                <p className='flex items-center gap-1'>
                    <span>400+ Clients Globally Innovating UI solution with us.</span>
                    <ChevronRight className='size-4' />
                </p>
            </a>

            <h1 className='mt-4 max-w-4xl scale-105 bg-gradient-to-r from-black to-[#010a18] bg-clip-text text-center text-4xl/12 font-bold text-transparent md:scale-100 md:text-6xl/20'>We Turn Ideas Into Powerful Digital Products</h1>
            <p className='mt-2 max-w-xl text-center text-base/7 text-gray-700'>From strategy to launch, we partner with you to build exceptional digital experiences that drive real impact.</p>
