...
export default function HeroSection() {
    ...
    return (
        <section className='flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 py-24 '>
            ...
            <a href='https://prebuiltui.com' className='mt-32 flex items-center gap-2 rounded-full border border-gray-100 bg-gray-50 text-xs px-3 py-1 xl:text-sm font-medium transition hover:bg-gray-50/80'>
                ...
                <p className='flex items-center gap-1'>
                    <span>400+ Clients Globally <span className="hidden xl:flex">Innovating UI solution with us.</span></span>
                    <ChevronRight className='size-4' />
                </p>
            </a>

            <h1 className='mt-8 md:mt-4 max-w-4xl scale-105 bg-gradient-to-r from-black to-[#010a18] bg-clip-text text-center text-3xl sm:text-4xl/10 font-bold text-transparent md:scale-100 md:text-6xl/20 w-[90%]'>We Turn Ideas Into Powerful Digital Products</h1>
