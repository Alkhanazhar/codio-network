...
export default function HeroSection() {
    ...
    return (
        <section className='flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 py-[3vw] '>
            ...
            <motion.div className='mt-[10vw] flex items-center gap-2 rounded-full border border-gray-100 bg-gray-50 text-xs px-3 py-1 xl:text-sm font-medium transition hover:bg-gray-50/80'>
            ...
            <Link href='/contact-us' className='mt-8 flex items-center gap-2 rounded-full bg-gray-900 px-8 py-2.5 font-medium text-white transition hover:opacity-90'>
